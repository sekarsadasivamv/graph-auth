    ...
    deleteIndex(index, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.client.indexes.deleteMethod(indexName, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: CanonicalCode.UNKNOWN,
            ...
            try {
                ...
                const etag = typeof synonymMap === "string"
                    ...
                    : options.onlyIfUnchanged
                        ? synonymMap.etag
                        : undefined;
                yield this.client.synonymMaps.deleteMethod(synonymMapName, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: CanonicalCode.UNKNOWN,
